...
/**
 * This class provides a wrapper for network errors when making requests to Budgets API
 */
export class BrexBudgetsError extends Error {
  /**
   * The response body
   */
